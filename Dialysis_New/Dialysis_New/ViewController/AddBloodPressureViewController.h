...
@interface AddBloodPressureViewController : UIViewController

@property (nonatomic, strong) IBOutlet UITextField *txtfieldSystolic;
@property (nonatomic, strong) IBOutlet UITextField *txtfieldDiastolic;
